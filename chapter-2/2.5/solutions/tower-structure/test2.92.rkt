...
(define poly-1 (make-polynomial 'x '(sparse (term 1 1))))
...
(define poly-15 (make-polynomial 'x '(sparse (term 1 1) (term 0 1))))
(define poly-16 (make-polynomial 'x '(sparse (term 3 1) (term 0 -1))))
(define poly-17 (make-polynomial 'x '(sparse (term 0 3))))
(define poly-18 (make-polynomial 'x '(sparse (term 2 1) (term 0 -1))))
