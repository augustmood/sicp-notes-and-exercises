...
; (general-eq? (make-complex-from-real-imag 10.0 0) (raise (project (make-complex-from-real-imag 10.0 0))))
; (raise (project (make-complex-from-real-imag 10.0 0)))

(drop (make-complex-from-real-imag 10.0 0))
...
;; only argument, and even from the understanding of coercion and the number-systems, We'd better
